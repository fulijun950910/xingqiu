...
<div layout="row" layout-align="center center" flex   class="fs24 p-t-4 p-b-4" v-if="payDetail.payMoney > 0">
       <div @click="offlinePayConfirm" class="extra-light-black fs28">线下支付</div>
