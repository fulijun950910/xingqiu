<template>
    <div class="tp-index" v-title="title">
        ...
        <div class="cell cell-box bg-white group-buy-content">
            ...
            <m-icon v-if="groupData.status == 3" link="icon-pintuanchenggong" class="color-primary icon"></m-icon>
        </div>
        <!--团情况-->
        <div class="cell cell-box bg-white m-t-3" >
            <div class="HotDate"><div class="hot-date">
                <div v-if="groupData.status == 3">团长人气太高，团满了</div>
                <div v-else-if="groupData.remainSecond > 0" class="color-primary"><m-icon link="icon-shalou"></m-icon>{{groupData.remainSecond | mTime}}</div>
                <div v-else>已结束</div>
            </div></div>
        ...
        <div class="btn-group text-center" layout="row" layout-align="space-around center">
            <div @click="goOrderList">
                <div><m-icon class="icon" link="icon-goumaijilu01"></m-icon></div>
                <div class="fs24">消费记录</div>
            </div>
            <div @click="showShare = true">
                <div><m-icon class="icon" link="icon-fenxiang"></m-icon></div>
                <div class="fs24">邀请好友</div>
            </div>
            <div @click="goIndex">
                <div><m-icon class="icon" link="icon-pintuan"></m-icon></div>
