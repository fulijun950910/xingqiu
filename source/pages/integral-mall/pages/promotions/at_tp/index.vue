    ...
    <div class="tp-index" >
        ...
        <div class="cell cell-box bg-white">
            ...
            <div class="color-gray m-t-3">
                <m-icon link="icon-xiangqing"></m-icon>
                ...
                <div @click="goPromotionDetail(item.id)" v-for="(item, index) in groupList" :key="index" class="listItem cell cell-box" layout="row">
                    ...
                    <div class="m-r-4" flex layout="column" layout-align="center start">
                        ...
                        <div layout="row" class="w100">
                            <div flex v-if="item.status == 1" class="color-gray"><m-icon link="icon-shalou"></m-icon>{{item.remainSecond | mTime}}</div>
                    ...
                    <div  layout="column" layout-align="center end">
                        ...
                        <m-icon v-else-if="item.status == 3" class="success-icon color-primary" link="icon-yueman"></m-icon>
        ...
        <div @click="goRecording" class="cell cell-box bg-white m-t-3" layout="row" layout-align="start center">
            <div flex>我的团拼记录</div>
            <m-icon class="fs32" link="icon-zuojiantou"></m-icon>
        </div>
        ...
        <!--我的团拼记录-->
        <div class="cell cell-box bg-white m-t-3" >
            <div class="m-b-3" @click="goRule">拼团玩法 <m-icon class="color-primary" link="icon-xunwen"></m-icon></div>
            <div class="rule-item" layout="row" layout-align="space-between start">
                <div flex="20" layout="column" layout-align="center center">
                    <m-icon class="color-primary rule-icon" link="icon-tuangou1"></m-icon>
                    <span class="fs22">开团或参团</span>
                </div>
                <m-icon class="fs32 color-gray m-t-4" flex="5" link="icon-zuojiantou"></m-icon>
                <div flex="20" layout="column" layout-align="center center">
                    <m-icon class="color-primary rule-icon" link="icon-zhifu"></m-icon>
                    <span class="fs22">付款</span>
                </div>
                <m-icon class="fs32 color-gray m-t-4" flex="5" link="icon-zuojiantou"></m-icon>
                <div flex="23" layout="column" layout-align="center center">
                    <m-icon class="color-primary rule-icon" link="icon-wangzhan-pintuan"></m-icon>
                    <span class="fs22">邀请好友拼团</span>
                </div>
                <m-icon class="fs32 color-gray m-t-4" flex="5" link="icon-zuojiantou"></m-icon>
                <div flex="20" layout="column" layout-align="center center">
                    <m-icon class="color-primary rule-icon" link="icon-xiaolian2"></m-icon>
