<template>
 ...
 <div @click="addAddress()"><m-icon link="icon-jia"></m-icon>新增地址</div>
        </div>
    ...
    <div @click="addDefault(item)" layout="row" layout-align="center center" class="default-address" :class="{'default' : item.isDefault}">
        默认&nbsp;&nbsp;<m-icon class="fs40" link="icon-gouicon1"></m-icon>
    </div>
    <div layout="row" layout-align="center center">
        <span class="color-yellow-orange" @click.stop="controllItem(item,1)"><m-icon class="fs34" link="icon-shanchu1"></m-icon></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <span class="color-blue" @click.stop="controllItem(item,2)"><m-icon class="fs34" link="icon-bianji"></m-icon></span>
    </div>
    </div>
            </div>
        ...
        <!-- <div class="add-address" layout="row" @click="addAddress()" layout-align="center center">
            <div><m-icon link="icon-jia"></m-icon>新增地址</div>
        </div> -->
