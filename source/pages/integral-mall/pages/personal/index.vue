    ...
    <div class="personal-container" v-title="'我的星球'">
        ...
        <div class="list-personal" flex>
            <div v-if="!$store.getters.isPersonLogin" layout="row" class="item" layout-align="space-between center">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-shenfen"></m-icon>登入账号身份</span>
            ...
            <div v-if="!$store.getters.isPersonLogin" layout="row" class="item" layout-align="space-between center" @click="routeTo(3)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-wodedingdan"></m-icon>我的订单</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div layout="row" class="item" layout-align="space-between center" @click="routeTo(9)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-navicon-cgdh"></m-icon>我的采购单</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div v-if="!$store.getters.isPersonLogin" layout="row" class="item" layout-align="space-between center" @click="routeTo(8)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-jieshao"></m-icon>推荐商户列表</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div v-if="!$store.getters.isPersonLogin" layout="row" class="item" layout-align="space-between center" @click="routeTo(4)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-gerenxinxi"></m-icon>个人信息</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div layout="row" class="item" layout-align="space-between center" @click="routeTo(5)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-wodedizhi"></m-icon>我的地址</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div layout="row" class="item" layout-align="space-between center" @click="routeTo(6)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-kefu"></m-icon>客服</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div v-if="!$store.getters.isPersonLogin" layout="row" class="item" layout-align="space-between center" @click="routeTo(7)">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-11"></m-icon>修改密码</span>
                <span class="color-gray right-icon text-right"><m-icon link="icon-zuojiantou"></m-icon></span>
            </div>
            <div layout="row" class="item" layout-align="space-between center" @click="signOut()">
                <span class="color-black fs28"><m-icon class="color-gray fs30" link="icon-tuichu"></m-icon>退出登录</span>
