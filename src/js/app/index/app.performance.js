...
var icons = ["68a;", "66a;", "665;", "689;", "685;", "687;", "684;", "691;", "694;", "693;", "68e;", "684;"];
    ...
    for (var i = memberData.performanceInfo.length - 1; i >= 0; i--) {
        ...
        switch (memberData.performanceInfo[i][0]) {
            ...
            case '支付宝':
                ...
                break;
            case '团购':
                memberData.performanceInfo[i].push(icons[4], rgbs[4]);
                break;
            case '减免':
                memberData.performanceInfo[i].push(icons[5], rgbs[5]);
                break;
            case '欠款':
